...
public class ByteBuffer
{
    ...
    */
    ...
    public List<byte> ReadListByte( int minLen = 0, int maxLen = 0 )
    {
        var len = ReadLength();
        if( len < minLen || (maxLen > 0 && len > maxLen) ) throw new Exception( " length too long" );
        List<byte> myList = new List<byte>(len);
        for( int i = 0; i < len; i++ )
        {
            myList.Add( ReadByte() );
        }
    ...
    */
    ...
    public List<short> ReadListShort( int minLen = 0, int maxLen = 0 )
    {
        var len = ReadLength();
        if( len < minLen || (maxLen > 0 && len > maxLen) ) throw new Exception( " length too long" );
        var myList = new List<short>(len);
        for( int i = 0; i < len; i++ )
        {
            myList.Add( ReadShort() );
        }
        return myList;
    }
    ...
    */
    ...
    public List<float> ReadListFloat( int minLen = 0, int maxLen = 0 )
    {
        var len = ReadLength();
        if( len < minLen || (maxLen > 0 && len > maxLen) ) throw new Exception( " length too long" );
        var myList = new List<float>(len);
        for( int i = 0; i < len; i++ )
        {
            myList.Add( ReadFloat() );
        }
        return myList;
    }
    ...
    */
    ...
    public List<double> ReadListDouble( int minLen = 0, int maxLen = 0 )
    {
        var len = ReadLength();
        if( len < minLen || (maxLen > 0 && len > maxLen) ) throw new Exception( " length too long" );
        var myList = new List<double>(len);
        for( int i = 0; i < len; i++ )
        {
            myList.Add( ReadDouble() );
        }
        return myList;
    }
    ...
    */
    ...
    public List<bool> ReadListBool( int minLen = 0, int maxLen = 0 )
    {
        var len = ReadLength();
        if( len < minLen || (maxLen > 0 && len > maxLen) ) throw new Exception( " length too long" );
        var myList = new List<bool>(len);
        for( int i = 0; i < len; i++ )
        {
            myList.Add( ReadBoolean() );
        }
        return myList;
    }
    ...
    */
    ...
    public List<string> ReadListString( int minLen = 0, int maxLen = 0 )
    {
        var len = ReadLength();
        if( len < minLen || (maxLen > 0 && len > maxLen) ) throw new Exception( " length too long" );
        var myList = new List<string>(len);
        for( int i = 0; i < len; i++ )
        {
            myList.Add( ReadString() );
        }
        return myList;
    }
    ...
    */
    ...
    public List<DateTime> ReadListDate( int minLen = 0, int maxLen = 0 )
    {
        var len = ReadLength();
        if( len < minLen || (maxLen > 0 && len > maxLen) ) throw new Exception( " length too long" );
        var myList = new List<DateTime>(len);
        for( int i = 0; i < len; i++ )
        {
            myList.Add( ReadDate() );
        }
